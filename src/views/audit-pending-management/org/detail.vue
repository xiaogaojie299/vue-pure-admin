<template>
  <div class="audit-detail">
    <!-- <div class="bg-white p-4 mb-2">
      <el-segmented v-model="currentType" :options="['组织信息', '评分指标']"></el-segmented>
    </div> -->
    <!-- <template v-if="currentType === '评分指标'">
      <SelectOrgTagDialog></SelectOrgTagDialog>
    </template> -->
      <el-card shadow="never">
        ...
        <div class="submit-btn">
          <el-button v-if="isEdit" type="primary" @click="handleSubmit"
            >提交</el-button
          >
          <el-button v-else type="primary" plain @click="handleClose"
            >关闭</el-button
          >
        </div>
      </el-card>
...
import {
  getOrgApproveDetail,
  approveOrg
} from "@/api/audit-pending-management";

import { getOrgNatureTree } from "@/api/categories-management";
import dayjs from "dayjs";

// import SelectOrgTagDialog from "@/views/organizational-management/index/components/ScoreDetails.vue";
